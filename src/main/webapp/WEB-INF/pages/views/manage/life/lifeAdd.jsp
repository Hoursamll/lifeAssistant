...
<div id="main-wrap" class="animated fadeIn">
    ...
    <div class="main-content">
        ...
        <form class="layui-form" action="${ctx}/manage/life/lifeSave" accept-charset="utf-8" method="post">
            <input id="id" type="hidden" name="id" value="${life.id}" required lay-verify="title" autocomplete="off" class="layui-input">
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">标题：</label>
                <div class="layui-input-block">
                    <input id="length" name="title"  required value="${life.title}" lay-verify="title" placeholder="如 橘子皮的妙用" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">内容：</label>
                <div class="layui-input-block">
                    <input id="width" name="message"  required value="${life.message}"  lay-verify="title" placeholder="如 橘子皮可以用来..." autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">知识插图</label>
                <div class="layui-input-block">
                        ...
                        <div class="layui-field-box" style="width:150px">
                            <section>
                                <div>
                                    ...
                                    <input type="text" style="width:300px" required readonly name="imgUrl" id="imgUrl" value="${life.imgUrl}">
                                </div>
                            </section>
                        </div>
                    </fieldset>
            ...
            <div class="layui-form-item" style="margin-top: 20px">
                ...
                <button type="button" class="layui-btn layui-btn-primary do-action" data-type="doGoBack" data-href="${ctx}/manage/life/lifeQuery">返回</button>
            </div>
            </div>
        </form>
    </div>
