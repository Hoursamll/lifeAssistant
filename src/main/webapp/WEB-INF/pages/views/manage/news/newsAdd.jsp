...
<div id="main-wrap" class="animated fadeIn">
    ...
    <div class="main-content">
        ...
        <form class="layui-form" action="${ctx}/manage/news/newsSave" accept-charset="utf-8" method="post">
            <input id="id" type="hidden" name="id" value="${news.id}" required lay-verify="title" autocomplete="off" class="layui-input">
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">标题：</label>
                <div class="layui-input-block">
                    <input id="length" name="title"  required value="${news.title}" lay-verify="title" placeholder="如 校园十佳歌手大赛" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">内容：</label>
                <div class="layui-input-block">
                    <input id="width" name="message"  required value="${news.message}"  lay-verify="title" placeholder="如 歌手大赛如火如荼的进行中..." autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item" style="margin-top: 20px">
                ...
                <button type="button" class="layui-btn layui-btn-primary do-action" data-type="doGoBack" data-href="${ctx}/manage/news/newsQuery">返回</button>
            </div>
        </form>
    </div>
</div>
