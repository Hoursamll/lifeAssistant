...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      {field: 'headImg', title: '图片', width: 100, templet: '#imgTpl'}
      ,{field: 'type',field: 'headImg', width: 100, title: '征收类目', sort: true}
      ,{field: 'payBy', title: '缴费信息'}
      ,{field: 'payMoney', title: '缴费金额', sort: true}
      ,{field: 'isNo', title: '是否分期', width: 200}
      ,{field: 'isMoney', title: '已缴金额', sort: true}
  ...
  table.on('tool(LAY-app-forumreply-list)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      layer.open({
        type: 2
        ,title: '新建项目'
        ,content: '../../../views/app/forum/levyAdd.html'
        ,area: ['800px', '500px']
        ,btn: ['确定', '取消']
        ,resize: false
        ,yes: function(index, layero){
