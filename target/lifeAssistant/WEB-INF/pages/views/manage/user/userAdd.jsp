...
<div id="main-wrap" class="animated fadeIn">
    ...
    <div class="main-content">
        ...
        <form class="layui-form" action="${ctxStatic}/manage/userSave" accept-charset="utf-8" method="post">

            <%--<input id="pName" type="hidden" name="pName" value="${pName}" required lay-verify="title" autocomplete="off" class="layui-input">--%>
            <div class="layui-form-item">
                <label class="layui-form-label">用户名：</label>
                <div class="layui-input-block">
                    <input id="carName" name="carName"  required value="${user.userName}" lay-verify="title" placeholder="如 君威20T尊享型" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">手机号：</label>
                <div class="layui-input-block">
                    <input id="length" name="length"  required  value="${user.phone}" lay-verify="phone" placeholder="如 4.9" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">电子邮箱：</label>
                <div class="layui-input-block">
                    <input id="oilWear" name="oilWear"  required value="${user.eamil}"  lay-verify="title" placeholder="如 8.9" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item" style="margin-top: 20px">
                <div class="layui-input-block">
                    ...
                    <button type="button" class="layui-btn layui-btn-primary do-action" data-type="doGoBack" data-href="${ctx}/manage/userQuery">返回</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    layui.use('upload', function(){
        layui.upload({
            url: '${ctxStatic}/manage/cate/uploadChildCateLogo'
            ,method: 'post'
