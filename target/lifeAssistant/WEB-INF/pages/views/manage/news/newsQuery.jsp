...
<div id="main-wrap" class="animated fadeIn">
    <div class="main-title">
        <h1>新闻资讯列表</h1>
        <div class="toolbar">
            <button class="layui-btn layui-btn-small do-action" data-type="doAdd" data-href="${ctx}/manage/news/newsAdd">
                <i class="layui-icon">&#xe608;</i> 添加新闻资讯
            </button>
        </div>
    </div>
    <hr>
                        ...
                        <ul class="layui-nav" lay-filter="">
                            <li class="layui-nav-item">
                                ...
                                <dl class="layui-nav-child">
                                    <dd><a href="javascript:;" class="do-action" data-type="doEdit" data-href="${ctx}/manage/news/newsAdd?id=${news.id}"><i class="layui-icon">&#xe642;</i>编辑</a></dd>
                                    <dd><a href="javascript:;" class="do-action" onclick="alertDel(${news.id})"><i class="layui-icon">&#xe640;</i>删除</a></dd>
                                </dl>
                            </li>
                        </ul>
                    </td>
                ...
                ,yes: function(index, layero){
                    $.ajax({
                        ...
                        success: function (data) {
                            layer.closeAll();
                            window.location.href="${ctx}/manage/news/newsQuery"
                        },
                        error: function (e) {
                            alert("删除失败！");
                            layer.closeAll();
